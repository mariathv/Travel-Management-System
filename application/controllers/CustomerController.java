 ...
 * 
 * @FXML
 * private Button nav_home_cus, nav_notifs_cus, nav_profile_cus,
 * nav_service_cus;
 * 
 * @FXML
 * private Text ServiceNo, From, To, Dtime, Atime, StationName, StationLoc,
 * Price;
 * 
 * @FXML
 ...
 * "../scenes/components/service_item.fxml"));
 * 
 * try {
 ...
 * sItemC.setData(arrivalLocation, departureLocation, arrivalTime,
 * departureTime, Type);
 * 
 ...
 * image = new
 * Image(getClass().getResourceAsStream("../assets/images/pngs/bus.png"));
 * }else if (serviceType.equals("Train")) {
 * image = new
 * Image(getClass().getResourceAsStream("../assets/images/pngs/train.png"));
 * }else if(serviceType.equals("Flight")) {
 * image = new
 * Image(getClass().getResourceAsStream("../assets/images/pngs/flight.png"));
 * }else {
 * image = new
 * Image(getClass().getResourceAsStream("../assets/images/pngs/hotel.png"));
 * }
 * 
 ...
 * private void changeBackButtonBG() {
 * switch(currentTab) {
 * case 1: nav_home_cus.setStyle("-fx-background-color:  #393D46;");
 * System.out.println("changed bg color"); break;
 * case 2: nav_service_cus.setStyle("-fx-background-color:  #393D46;");
 * System.out.println("changed bg color"); break;
 * case 3: nav_notifs_cus.setStyle("-fx-background-color:  #393D46;");
 * System.out.println("changed bg color"); break;
 * case 4: nav_profile_cus.setStyle("-fx-background-color:  #393D46;");
 * System.out.println("changed bg color"); break;
 * }
 * }
 * 
